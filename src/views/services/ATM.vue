<template>
  <v-container>
    <div style="font-size: 25px;" class="mb-3 mt-10">KUSCCOOP SCT DEBIT CARD</div> 
    ...
    <div style="font-size: 25px;" class="mb-3 mt-10">Fees & Charges</div>
    <table>
      <thead>
        <tr>
          <th>S.N.</th>
    ...
    <div style="font-size: 25px;" class="mb-1 mt-10">ATM (Debit Card )</div>
    <ul>
      <li v-for="(item, i) in items" :key="i">{{ item }}</li>  
    </ul>

    <div style="font-size: 25px;" class="mb-1 mt-10">ATM Location</div>
    <div style="border: .5px solid rgb(0 0 0 / 60%);" class="pa-3 text-center">
      <div class="title pb-1" style="line-height: 1;">Head Office</div>  
      <p style="font-weight: 400 !important;" class="my-1">Kumari Saving Co-Operative Ltd. (KUSCCOOP)</p>
      <p>Kumari Co-Operative Building, Kumari Chowk, Chabahil, Mitrapark, Kathmandu, Nepal</p>
    </div>
  </v-container>  
</template>
